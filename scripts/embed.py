...
surface_path = 'Lisurfcenter_Garvit_6L.xyz'
surface_superlattice_path = 'Lisurfcenter_hollow_superlattice.xyz'
...
print(f"Supercell repeated {2*n+1}x{2*n+1}x1 with updated cell dimensions. Output written to {surface_superlattice_path}.")
